export const otpTemplate = (otp: string, username: string) => {
  return `<!DOCTYPE html>
	...
	<head>
		<meta charset="UTF-8">
		<title>Stealth Feedback Verification Email</title>
		<style>
			body {
	...
	<body>
		<div class="container">
			...
			<div class="body">
				<p>Dear ${username},</p>
				<p>Thank you for registering with Stealth Feedback. To complete your registration, please use the following OTP
